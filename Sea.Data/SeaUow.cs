...
namespace Sea.Data
{
    public class SeaUow : ISeaUow, IDisposable
    {
        ...
        public IVesselRepository Vessel { get { return GetRepo<IVesselRepository>(); } }
        public IVesselDocumentRepository VesselDocument { get { return GetRepo<IVesselDocumentRepository>(); } }
