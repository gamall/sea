...
namespace Sea.Data.Helpers
{
    public class RepositoryFactories
    {
        private IDictionary<Type, Func<DbContext, object>> GetSeaFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                    {typeof(IVesselRepository), dbContext => new VesselRepository(dbContext)},
                    {typeof(IVesselDocumentRepository), dbContext => new VesselDocumentRepository(dbContext)}
                };
        }
        ...
        {
            _repositoryFactories = GetSeaFactories();
        }
